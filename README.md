...
- `-f FORMAT`  : Format-Vorgabe (`br2` für 2-Spalten-Bericht mit Optima [Standard], `br1` für 1-Spalten-Bericht mit PT Serif, `atk1` für 3-Spalten-Artikel mit Big Caslon ohne Trennlinie, `atk2` für 3-Spalten-Artikel mit PT Serif und Trennlinie, `apa` für 7. Edition APA-Bericht).
